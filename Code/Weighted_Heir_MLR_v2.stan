...
model {
  bsd ~ normal(1, 100); // prior for the sd
  bloc ~ normal(0, 100); // priors for the betas 
  asd ~ normal(1, 100); // prior for the alpha sd
  aloc ~ normal(0, 100); // prior for the alpha means
  for (k in 1:(K-1)) {
